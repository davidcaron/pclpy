...
void defineGeometryQuadMesh(py::module &m, std::string const & suffix) {
    using Class = geometry::QuadMesh<MeshTraitsT>;
    ...
    py::class_<Class, geometry::MeshBase<QuadMesh<MeshTraitsT>,MeshTraitsT,QuadMeshTag>, boost::shared_ptr<Class>> cls(m, suffix.c_str());
    cls.def(py::init<>());
...
void defineGeometryQuadMeshTag(py::module &m) {
    using Class = geometry::QuadMeshTag;
