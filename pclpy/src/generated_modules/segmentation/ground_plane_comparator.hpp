...
void defineSegmentationGroundPlaneComparator(py::module &m, std::string const & suffix) {
    using Class = pcl::GroundPlaneComparator<PointT, PointNT>;
    ...
    cls.def("setGroundAngularThreshold", &Class::setGroundAngularThreshold, "angular_threshold"_a);
    cls.def("setExpectedGroundNormal", &Class::setExpectedGroundNormal, "normal"_a);
...
void defineSegmentationGroundPlaneComparatorFunctions(py::module &m) {
}
